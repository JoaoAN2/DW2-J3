    ...
    <body>
        <div class="d-flex justify-content-center align-items-center min-vh-100">
            <form action="Buscar" class="border border-dark p-5" method="POST">
                ...
                <h2 class="mt-5 mb-3">Pesquisar Torneio</h2>
                <input type="number" class="form-control mb-3" placeholder="Id do Torneio" name="id" required>
                <div class="text-center mt-3 mb-2">
                    <a href="inserir.jsp" class="btn btn-danger">Inserir torneio</a>
                    <button type="submit" class="btn btn-success">Procurar torneio</button>
                    <a href="listar.jsp" class="btn btn-primary">Listar torneios</a>
                </div>
