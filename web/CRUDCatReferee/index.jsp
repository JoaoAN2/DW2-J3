    ...
    <body>
        <div class="d-flex justify-content-center align-items-center min-vh-100">
            <form action="Buscar" class="border border-dark p-5" method="POST">
                ...
                <h2 class="mt-5 mb-3">Pesquisar Categoria de Árbitro</h2>
                <input type="text" class="form-control mb-3" placeholder="Sigla" name="id" maxlength="3" required>
                <div class="text-center mt-3 mb-2">
                    <a href="inserir.jsp" class="btn btn-danger">Inserir Categoria de Árbitro</a>
                    <button type="submit" class="btn btn-success">Procurar Categoria de Árbitro</button>
                    <a href="listar.jsp" class="btn btn-primary">Listar Categoria de Árbitros</a>
                </div>
