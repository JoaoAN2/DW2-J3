...
<html lang="pt-br">
    ...
    <body>
        ...
        <%
            ...
            session.setAttribute("tournament", result);
        ...
        <div class="d-flex justify-content-center align-items-center min-vh-100">
            <form action="Alterar" class="border border-dark p-5" method="POST">
                ...
                <h2 class="mt-5 mb-2">CRUDs nxm</h2>
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="../CRUDArbitration/index.jsp" class="w-100 btn btn-danger">Árbitragem</a></li>
                    <li class="mb-2"><a href="../CRUDTournaments/index.jsp" class="w-100 btn btn-primary">Torneio</a></li>
                </ul>
            </form>
        </div>
