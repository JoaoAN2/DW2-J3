 ...
 * @author J³
 */
@WebServlet(name = "BuscarReferee", urlPatterns = {"/CRUDReferee/Buscar"})
public class Buscar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Referee referee = daoReferee.obter(id);

        request.setAttribute("refereeBuscar", referee);
        request.getRequestDispatcher("referee.jsp").forward(request, response);
    }
