package Servlets.CRUDCatReferee;
 ...
 * @author joaoan2
 */
@WebServlet(name = "AlterarCatReferee", urlPatterns = {"/CRUDCatReferee/Alterar"})
public class Alterar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<catReferee>Servlet Servlet</catReferee>");
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("message", "CatReferee: " + catReferee.getSiglaCatReferee()+ " atualizado com sucesso");
